        ...
        <table className="data-table w-full">
          <thead>
            <tr className="bg-[#CCE3DE]/30 border-b border-[#CCE3DE]">
              <th className="text-left text-sm font-semibold text-[#3D5A4C]">
                Nombre
              </th>
              <th className="text-left text-sm font-semibold text-[#3D5A4C]">
                Email
              ...
              <th className="text-right text-sm font-semibold text-[#3D5A4C]">
                Acciones
              </th>
            </tr>
          </thead>
                ...
                >
                  <td>
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-[#6B9080] flex items-center justify-center text-white font-medium text-sm flex-shrink-0">
                        {user.fullName.charAt(0).toUpperCase()}
                      </div>
                      <div className="cell-truncate">
                        <span className="font-medium text-[#2D3D35] truncate block" title={user.fullName}>
                          {user.fullName}
                          {isCurrentUser && (
                  ...
                  <td>
                    <span className="text-sm text-[#5C7A6B] cell-truncate-sm block" title={user.email}>{user.email}</span>
                  </td>
                  <td>
                    <span
                      className={cn(
